...
public class CheckOutModel implements Serializable {
    ...
    public CheckOutModel(OrdersModel ordine, BooksModels libro, BigDecimal libroPrezzo, Integer quantita) {
        this.ordine = ordine;
        this.libro = libro;
    ...
    public BooksModels getLibro() { return libro; }
    public void setLibro(BooksModels libro) { this.libro = libro; }
