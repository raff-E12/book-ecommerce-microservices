...
public class UserModel implements Serializable {
    ...
    private List<RateModel> recensioni;
    ...
    public List<RateModel> getRecensioni() { return recensioni; }
    public void setRecensioni(List<RateModel> recensioni) { this.recensioni = recensioni; }
